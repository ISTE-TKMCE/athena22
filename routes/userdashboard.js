...
router.get(
  ...
  redirect.RedirectLogin,
  redirect.RedirectVerify,
  dashcontroller.loadworkshopsatreg
);
router.get(
  "/registerevent",
  redirect.RedirectLogin,
  redirect.RedirectVerify,
  dashcontroller.loadeventsateventreg
);
...
router.get(
  ...
  redirect.RedirectLogin,
  redirect.RedirectVerify,
  paymentcontroller.amountgenerator
);
router.post(
  "/eventpayment",
  redirect.RedirectLogin,
...
router.post(
  ...
  redirect.RedirectLogin,
  redirect.RedirectVerify,
  paymentcontroller.paymentaftercontrol
);
router.get(
  "/unravel/form",
  redirect.RedirectLogin,
  redirect.RedirectVerify,
  dashcontroller.ravelform
);
router.post(
  "/unravel/submit",
  redirect.RedirectLogin,
  redirect.RedirectVerify,
  dashcontroller.ravelformsubmit
);
